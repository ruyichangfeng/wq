...
class Core extends WeModuleSite {
	...
	// ===============================================
	public $m = 'wx_school_t';
	public $table_classify = 'wx_school_t_classify';
	public $table_score = 'wx_school_t_score';
	public $table_news = 'wx_school_t_news';
	public $table_index = 'wx_school_t_index';
	public $table_students = 'wx_school_t_students';
	public $table_tcourse = 'wx_school_t_tcourse';
	public $table_teachers = 'wx_school_t_teachers';
	public $table_area = 'wx_school_t_area';
    public $table_type = 'wx_school_t_type';
    public $table_kcbiao = 'wx_school_t_kcbiao';
	public $table_cook = 'wx_school_t_cookbook';
	public $table_reply = 'wx_school_t_reply';
	public $table_banners = 'wx_school_t_banners';
	public $table_bbsreply = 'wx_school_t_bbsreply';
	public $table_user = 'wx_school_t_user';
	public $table_set = 'wx_school_t_set';
	public $table_leave = 'wx_school_t_leave';
	public $table_notice = 'wx_school_t_notice';
	public $table_bjq = 'wx_school_t_bjq';
	public $table_media = 'wx_school_t_media';
	public $table_dianzan = 'wx_school_t_dianzan';
	public $table_order = 'wx_school_t_order';
    public $table_wxpay = 'wx_school_t_wxpay';
    public $table_group = 'wx_school_t_fans_group';
	public $table_qrinfo = 'wx_school_t_qrcode_info';
	public $table_qrset = 'wx_school_t_qrcode_set';
	public $table_qrstat = 'wx_school_t_qrcode_statinfo';
	public $table_cost = 'wx_school_t_cost';
	public $table_object = 'wx_school_t_object';
	public $table_signup = 'wx_school_t_signup';
	public $table_record = 'wx_school_t_record';
	public $table_checkmac = 'wx_school_t_checkmac';
	public $table_checklog = 'wx_school_t_checklog';
	public $table_idcard = 'wx_school_t_idcard';
	public $table_icon = 'wx_school_t_icon';
	public $table_newchecklog = 'wx_school_t_newchecklog';//新考勤
	public $table_flow = 'wx_school_t_flow';//流程
	public $table_parents = 'wx_school_t_parents';//家长表
	public $table_book = 'wx_school_t_book';//闲书表
	public $table_mybook = 'wx_school_t_mybook';//我的闲书
	public $table_myorder = 'wx_school_t_myorder';//借书订单
	public $table_mytransferorder = 'wx_school_t_mytransferorder';//易书订单
	public $table_bookcomment = 'wx_school_t_bookcomment';//闲书评论
	public $table_bookaccount = 'wx_school_t_bookaccount';//闲书账户
	public $table_bookmargin = 'wx_school_t_bookmargin';//保证金管理
	public $table_booktempimg = 'wx_school_t_booktempimg';//闲书图片临时表
	public $table_bookscore = 'wx_school_t_bookscore';//闲书评论表
	public $table_booklog = 'wx_school_t_booklog';//闲书日志表
	public $table_torder = 'wx_school_t_torder';//闲书教师订单
...
//		$category = pdo_fetchall("SELECT * FROM " . tablename($this->table_classify) . " WHERE :weid = weid AND :schoolid =schoolid", array(':weid' => $weid, ':schoolid' => $schoolid), 'sid');
	...
	public function sendMobileXsddtz($schoolid,$orderId, $weid, $orderType,$action = 'in') {
		...
		$url =  $_W['siteroot'] .'app/'.$this->createMobileUrl('mybookorder', array('schoolid' => $schoolid, 'op' => $op));
		if (!empty($template_id)) {
			$this->sendtempmsg($template_id, $url, $data, '#FF0000', $openid);
		}
	}
	...
	public function sendMobileXsedbdtz($params) {
		...
		if($orderType == 'borrow'){
			...
			$datas=array(
				...
				'keyword3'=>array('value'=>$amountData[$order['openid']]['preAmount'],'color'=>'#FF9E05'),
			...
			$datas1=array(
				'first'=>array('value'=>$title1,'color'=>'#FF9E05'),
				'keyword1'=>array('value'=>'闲书出库增额','color'=>'#1587CD'),
				'keyword2'=>array('value'=>$order['price'],'color'=>'#FF9E05'),
				'keyword3'=>array('value'=>$amountData[$order['bookownerid']]['preAmount'],'color'=>'#FF9E05'),
			...
			$url1 =  $_W['siteroot'] .'app/'.$this->createMobileUrl('mybookorder', array('schoolid' => $schoolid, 'op' => $op));
			if (!empty($template_id)) {
			...
			$remark = '点击详情，进入查看已完成订单。';
			$url =  $_W['siteroot'] .'app/'.$this->createMobileUrl('mybookorder', array('schoolid' => $schoolid, 'op' => 'transfer'));
			$datas=array(
				'first'=>array('value'=>$title,'color'=>'#FF9E05'),
				'keyword1'=>array('value'=>'易书差额增计闲书币','color'=>'#1587CD'),
				'keyword2'=>array('value'=>sprintf('%0.2f',($order['outPrice']-$order['inPrice'])),'color'=>'#FF9E05'),
				'keyword3'=>array('value'=>$amountData[$order['openid']]['preAmount'],'color'=>'#FF9E05'),
				'keyword4'=>array('value'=>sprintf('%0.2f',$amountData[$order['openid']]['afterAmount']),'color'=>'#FF9E05'),
				'keyword5'=>array('value'=>$ttime,'color'=>'#FF9E05'),
				'remark' => array('value'=>$remark,'color'=>'#1587CD'),
			...
			$datas1=array(
				'first'=>array('value'=>$title1,'color'=>'#FF9E05'),
				'keyword1'=>array('value'=>'易书差额减计闲书币','color'=>'#1587CD'),
				'keyword2'=>array('value'=>sprintf('%0.2f',($order['outPrice']-$order['inPrice'])),'color'=>'#FF9E05'),
				'keyword3'=>array('value'=>$amountData[$order['partybopenid']]['preAmount'],'color'=>'#FF9E05'),
