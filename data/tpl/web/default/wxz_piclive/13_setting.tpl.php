	...
	<form action="" method="post" class="form-horizontal form">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="col-md-10">
                                    <input type="radio" name="is_invite" value="1" <?php  if($settings['is_invite'] == 1) { ?>checked="checked"<?php  } ?>>开启&nbsp;
									<input type="radio" name="is_invite" value="0" <?php  if($settings['is_invite'] == 0) { ?>checked="checked"<?php  } ?>>关闭
				...
				<div class="col-md-10">
                                    <input type="radio" name="is_video" value="1" <?php  if($settings['is_video'] == 1) { ?>checked="checked"<?php  } ?>>开启&nbsp;
									<input type="radio" name="is_video" value="0" <?php  if($settings['is_video'] == 0) { ?>checked="checked"<?php  } ?>>关闭
                                    <span class="help-block"></span>
				</div>
                            </div>
                            <div class="form-group">
				...
				<!--<div class="col-md-10">
                                    <input type="text" name="thumb_width" class="form-control" value="" />
                                    <span class="help-block"></span>
				</div>-->
                                <div class="input-group">
					<span class="input-group-addon">宽</span>
					<input name="thumb_width" value="<?php  echo $settings['thumb_width'];?>" type="text" class="form-control">
