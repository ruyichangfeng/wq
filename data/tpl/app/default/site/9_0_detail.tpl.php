...
<div class="page-content">
	...
	<?php  if(!empty($setting['comment_status'])) { ?>
	<div class="message">
		<div class="message-head">
			<a href="<?php  echo murl('site/site/comment', array('article_id' => $id))?>">写留言 <img src="<?php  echo $_W['siteroot'];?>app/resource/images/reply.png" alt=""></a>
		</div>
		<?php  if(is_array($article_lists)) { foreach($article_lists as $comment) { ?>
		<div class="message-list">
			<div content="message-item">
				<div class="message-content">
					<img src="http://prox/app/themes/default/preview.jpg" alt="" class="logo">
				...
				<?php  if(is_array($comment['son_comment'])) { foreach($comment['son_comment'] as $son_comment) { ?>
