        ...
        show: function (a, b) {
            ...
            case "video":
                j = "视频", typeUnit = "个", k = {
                    ...
                    mimeTypes: "video/*"
                }, l = 10, m = 104857600, n = l * m, o = !1, p.options.isWechat && (l = 5, "temp" == p.options.mode ? (k.extensions = "mp4", m = 10485760, n = 52428800) : (m = 20971520, n = 104857600))
            }
            ...
            var x = {
                ...
                server: p.options.isWechat ? "./index.php?c=utility&a=wechat_file&do=upload" : "./index.php?c=site&a=entry&op=upload&do=file&m=wxz_piclive&type=" + b,
                compress: o,
                accept: k,
                fileNumLimit: l,
                fileSizeLimit: n,
            ...
            if (d.options.isWechat) var e = d.options.type,
                ...
                g = "./index.php?c=utility&a=file&do=local",
                h = {
                    page: c,
                    year: i,
                    month: j
