                                        ...
                                        <table class="table-bordered table-hover" style="width:100%;line-height:40px;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="padding-left:15px;">区域名称</th>
													<th style="padding-left:15px;">所属代理</th>	
													<th style="padding-left:15px;">设备总数</th>													
                                                    <th style="text-align:Center;padding-left:15px;">经纬度</th>
													<th style="padding-left:15px;">详细地址</th>	
                                            ...
                                            <tbody>
											 ...
											 <?php  if(is_array($list)) { foreach($list as $index => $item) { ?>
                                                <tr>
                                                    ...
                                                    <td  style="padding-left:15px;"><?php  echo $item['area_name'];?></td>
													<td  style="padding-left:15px;"><span style="color:red;"><?php  echo $item['agent_name'];?></span></td>
													<td  style="padding-left:15px;"><?php  echo $item['num_count'];?> 台</td>
													<td align="center"><?php  echo $item['latitu'];?></td>
													<td  style="padding-left:15px;"><?php  echo $item['address'];?></td>
