...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="">审核工人</a></li>
</ul>
<div class="clearfix">    
    <form id="theform" class="form form-horizontal" action="<?php  echo $this->createWebUrl('company', array('foo'=>'staffshengok'));?>" method="post">
						...
						<div class="ub-f1 ub ub-ver ubl ubr b-bla01" style=" padding:0.3rem 0.5rem">
							...
							<div class="ulev-4 t-gra" style="padding:0.3rem 0">
                                ...
                                <a href="<?php  echo $_W['attachurl'];?><?php  echo $vo['pic1'];?>">
                                    <img src="<?php  echo $_W['attachurl'];?><?php  echo $vo['pic1'];?>" style="width:32%; height:150px;">
                                </a>
                                <?php  } else { ?>
                                <a href="<?php  echo $_W['attachurl'];?>gohome/cardpic/<?php  echo $vo['pic1'];?>">
                                    <img src="<?php  echo $_W['attachurl'];?>gohome/cardpic/<?php  echo $vo['pic1'];?>" style="width:32%; height:150px;">
                                </a>    
                                <?php  } ?>
                                ...
                                <?php  if($vo['pic2'] != '') { ?>
                                    <?php  if(substr($vo['pic2'],0,6) == 'images') { ?>
                                        <a href="<?php  echo $_W['attachurl'];?><?php  echo $vo['pic2'];?>">
                                        	<img src="<?php  echo $_W['attachurl'];?><?php  echo $vo['pic2'];?>" style="width:32%; height:150px;">
                                        </a>
                                    <?php  } else { ?>
                                        <a href="<?php  echo $_W['attachurl'];?>gohome/cardpic/<?php  echo $vo['pic2'];?>">
                                        	<img src="<?php  echo $_W['attachurl'];?>gohome/cardpic/<?php  echo $vo['pic2'];?>" style="width:32%; height:150px;">
                                        </a>
                                    <?php  } ?>
                                <?php  } ?>
                                ...
                                <?php  if($vo['pic3'] != '') { ?>
                                    <?php  if(substr($vo['pic3'],0,6) == 'images') { ?>
                                        <a href="<?php  echo $_W['attachurl'];?><?php  echo $vo['pic3'];?>">
                                        	<img src="<?php  echo $_W['attachurl'];?><?php  echo $vo['pic3'];?>" style="width:32%; height:150px;">
                                        </a>
                                    <?php  } else { ?>
                                        <a href="<?php  echo $_W['attachurl'];?>gohome/cardpic/<?php  echo $vo['pic3'];?>">
                                        	<img src="<?php  echo $_W['attachurl'];?>gohome/cardpic/<?php  echo $vo['pic3'];?>" style="width:32%; height:150px;">
                                        </a>
                                    <?php  } ?>
                                <?php  } ?>
                            </div>
