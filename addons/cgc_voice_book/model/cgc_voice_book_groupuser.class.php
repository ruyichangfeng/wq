...
class cgc_voice_book_groupuser{
  public function __construct(){
    $this->table_name = "cgc_voice_book_groupuser";
    $this->columns = "*";
  }
  ...
  public function deleteAll() {
   ...
   public function deleteAllByGroup($group_id) {
    global $_W;
    $condition = "`uniacid`=:uniacid and group_id=:group_id";
    $pars = array();
    $pars[":uniacid"] = $_W["uniacid"];
