...
<main>
    ...
    <div class="mui-card-content mui-card-content1">
        ...
        <div class="card-button">
            <div class="container zlinfo" style="margin-top:10px"><h4><?php  echo $firend['nickname'];?>，<?php  echo $this->getTipMsg($xkwkj, $this::$TIP_FK_FIRST)?></h4>
...
<script>
    ...
    function kj() {
        ...
        $.ajax({
            ...
            data:{"uid":<?php  echo $user['id'];?>, "weapon_seq": 1, "name_seq": 1},
            success: function (res) {
                ...
                if (res.code !=1 ) {
                    ...
                    swal({
                                title: "提示",
                                text: "太棒了，您帮<?php  echo $user['nickanme'];?>砍掉了" + res.price + "元!赶快邀请小伙伴帮他砍价吧！",
                                type: "success",
