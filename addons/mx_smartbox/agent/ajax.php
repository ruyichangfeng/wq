...
if(isset($_POST['ac']) &&  $_POST['ac'] == 'fpage'){
	...
	if($list){
		...
		//$QrCodeUrlurl = 'http://'.$_SERVER['SERVER_NAME'].'/addons/mx_smartbox/agent/qrcode.php?state='.$_SESSION['Id'].'_'.$_SESSION['Uniacid'].'_'.$k['did']."";
        $QrCodeUrlurl = 'http://'.$_SERVER['SERVER_NAME'].'/addons/mx_smartbox/agent/qrcode.php?state='.$aid.'_'.$uniacid.'_'.$k['did']."";  
