...
<div id="page0" class="ub ub-ver bga">
    ...
    <div class="ubb ubb-blaimg ub ub tx-c top-tab">
        ...
        <a href="<?php  echo $this->createMobileUrl('stafforder',array('foo'=>'order3','merchant_state'=>$merchant_state, 'id'=>$id))?>" class=" ub-f1 uinn t-gra block active">成功单</a>
    </div>
    <ul class="ub-f1 uinn8 c-wh">
        ...
        <?php  } else { ?>
        	<?php  if(is_array($list)) { foreach($list as $vo) { ?>
                <a href="<?php  echo $this->createMobileUrl('stafforder',array('foo'=>'yes','id'=>$vo['order_id'],'offer'=>$vo['offer'],'staff_id'=>$vo['staff_id']))?>" class="uba b-bla01 uc-a15 ub ub-ac umar-b" style="padding:0.2rem 0">
                    ...
                    <div class="ub-f1 ub ub-ver ubl ubr b-bla01" style=" padding:0.3rem 0.5rem">
                        <div class="ub ub-ac">
                            ...
                            <div class="t-gre1">
                            	<span class=" ulev1">
                            		<?php  if($vo['offer'] == '') { ?>0<?php  } else { ?><?php  echo $vo['offer'];?><?php  } ?>
                            	</span>
                            </div>
                        </div>
                        ...
                        <div class="ulev-4 t-gra">
                            <div><?php  echo $this->getOrderGrab($vo['order_id'],'fadr')?></div>
                        </div>
                    ...
                    <div class="ub ub-ver ub-ac ub-pc uinn8 ">
                        <?php  if($vo['suremoney'] == '') { ?>
                        <i class="iconfont icon-sousuo15 ulev2 t-red"></i>
                        <div class="ulev-4 t-red umar-t">确认</div>
                        <?php  } else { ?>
                        <i class="iconfont icon-sousuo15 ulev2 t-gre1"></i>
                        <div class="ulev-4 t-gre1 umar-t">成功</div>
                        <?php  } ?>
                    </div>
                </a>
             <?php  } } ?>   
