    ...
    <div class="main">
        <form method="post" class="form-horizontal form" id="form" novalidate="novalidate" >
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-8">
                    <?php  echo tpl_ueditor('post[desc]',$data['desc']);?>
                </div>
            </div>
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 col-lg-2 control-label">展示图</label>
                <div class="col-xs-12 col-sm-8">
                    <?php  echo tpl_form_field_image('post[img]',$data['img']);?>
                </div>
            </div>
            <div class="form-group">
