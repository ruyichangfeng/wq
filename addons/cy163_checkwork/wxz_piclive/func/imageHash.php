...
class ImageHash {
  ...
  public static function run($src1, $src2) {
    ...
    if(!is_file($src1) || !is_file($src2)) return self::FILE_NOT_FOUND;
  ...
  public function getImage($file) {
    ...
    if(!in_array($extname, ['jpg','jpeg','png','gif'])) return self::FILE_EXTNAME_ILLEGAL;
...
//var_dump(ImageHash::run('./head_img.png', './head_img2.png'));