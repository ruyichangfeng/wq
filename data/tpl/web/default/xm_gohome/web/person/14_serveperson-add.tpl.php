...
<ul class="nav nav-tabs">
    <li><a href="<?php  echo  $this->createWebUrl('serveperson', array('foo'=>'index'));?>">工人管理</a></li>
    <li class="active"><a href="<?php  echo  $this->createWebUrl('serveperson', array('foo'=>'add'));?>">添加工人</a></li>
</ul>

<div class="clearfix">    
    <form id="theform" class="form form-horizontal" action="<?php  echo $this->createWebUrl('serveperson', array('foo'=>'addok'));?>" method="post">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <span class="help-block">工龄是按月计算的，如1年=12个月，只需填入12</span>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <?php  echo tpl_form_field_image('avatar',$item['avatar']);?>
                         <span class="help-block">推荐尺寸：200X200</span>  
                    </div>
                </div>
