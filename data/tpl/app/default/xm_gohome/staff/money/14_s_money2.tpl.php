...
<div id="page0" class="ub ub-ver bga">
    <div class="ubb ubb-blaimg ub ub tx-c top-tab">
        ...
        <a href="<?php  echo $this->createMobileUrl('staffmoney', array('foo'=>'log', 'id'=>$id))?>" div class="ubr b-bla01 ub-f1 uinn t-gra block active">充值</a>
    </div>
        ...
        <?php  } else { ?>
        	<?php  if(is_array($list)) { foreach($list as $vo) { ?>
            	...
            	<table width="100%" border="0">
                  <tr>
                    <td class="uinn3">充值：￥<?php  echo $vo['money'];?></td>
                    <td class="uinn3"><?php  echo $vo['remark'];?></td>
                  </tr>
                  <tr>
                    <td colspan="2" class="uinn3">充值时间：<?php  echo $vo['addtime'];?></td>
                  </tr>
                </table>
                </div>
                <!--
