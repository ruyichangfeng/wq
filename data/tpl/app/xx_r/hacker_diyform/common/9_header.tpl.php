...
<head>
	...
	<title><?php  if(!empty($title)) { ?><?php  echo $title;?> - <?php  } else if(!empty($_W['page']['title'])) { ?><?php  echo $_W['page']['title'];?> - <?php  } ?>
	<?php  if(!empty($_W['page']['sitename'])) { ?><?php  echo $_W['page']['sitename'];?><?php  } else { ?><?php  echo $_W['account']['name'];?><?php  } ?></title>
	...
	<link href="<?php  echo $_W['siteroot'];?>app/resource/css/bootstrap.min.css?v=20160824" rel="stylesheet">
