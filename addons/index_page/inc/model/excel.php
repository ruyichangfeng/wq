...
class Index_Page_Excel
{
    ...
    function export($list, $params = array())
    {
        ...
        $excel = new PHPExcel();
        $excel->getProperties()->setCreator("借贷")->setLastModifiedBy("借贷")->setTitle("Office 2007 XLSX Test Document")->setSubject("Office 2007 XLSX Test Document")->setDescription("Test document for Office 2007 XLSX, generated using PHP classes.")->setKeywords("office 2007 openxml php")->setCategory("report file");
