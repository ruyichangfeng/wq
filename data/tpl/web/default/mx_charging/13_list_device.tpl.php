                                        ...
                                        <table class="table-bordered table-hover" style="width:100%;line-height:60px;">
                                            ...
                                            <tbody>
                                               ...
                                               <tr>
                                                    ...
                                                    <td style="padding-left:10px;"><?php  echo $item['device_code'];?></td>
													<td style="padding-left:10px;"><?php  echo $item['area_name'];?></td>
													<td style="padding-left:10px;"><?php  echo $item['agent_name'];?> 
													
													<?php  if($item['true_name'] != "") { ?>
														<span style="color:red;"> -- <?php  echo $item['true_name'];?></span>
													<?php  } ?>
													</span></td>
                                                   <td  style="text-align:center;">
                                                    ...
                                                    <td  style="text-align:center;">													
													<button  alt="<?php  echo $item['fid'];?>"  type="button" class="btn btn-info checksta">检测状态</button> 
													&nbsp;&nbsp;													
...
<script>
	...
	$(".checksta").click(function(){
		...
		$.post("<?php  echo $this->createWeburl('ajax')?>",{'action':'checkSta','fid':fid,'uniacid':<?php  echo $uniacid;?>},function(response,status,xhr){
			 if(response == 1){
				 alert('设备在线');
			 }else if(response == 0){
				 alert('设备离线');
