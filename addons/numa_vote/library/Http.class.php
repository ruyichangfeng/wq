...
class Http {
    ...
    */
    ...
    static public function download ($filename, $showname='',$content='',$expire=180) {
	    ...
	    $showname_encode = urlencode($showname); 
	    $showname_encode = str_replace("+","%20", $showname_encode);
		if(!empty($filename)) {
		...
		{
			header('Content-Disposition: attachment; filename="' . $showname_encode.'"'); 
		}else if(preg_match("/Firefox/", $ua))
		{
			header('Content-Disposition: attachment; filename*="utf8\'\''. $showname_encode .'"');
		}else 
		{
