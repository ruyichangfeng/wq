        ...
        <div class="tpl-header-fluid">
            ...
            <div class="am-fr tpl-header-navbar">
                <ul>
                    <!-- 退出 -->
                    <li class="am-text-sm">
                        <a href="<?= $we7_url ?>web/index.php?c=wxapp&a=display">
...
<div class="copyright" style="position:absolute;bottom:1px; width:100%;text-align:center;">
    <?php if ( empty($we7_copyright['footerleft']) ){?>
    Powered by <a href="http://www.we7.cc"><b>微擎</b></a> v<?php echo $we7_version;?> © 2014-2015 <a href="http://www.we7.cc">www.we7.cc</a>
<?php } else { echo $we7_copyright['footerleft'] ;}?>
</div>
    <?php if (!empty($we7_copyright['icp'])) {?><div>备案号：<a href="http://www.miitbeian.gov.cn" target="_blank"><?php echo $we7_copyright['icp'];?></a></div><?php }?>
