...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetAppid(WxPayConfig::APPID);//服务商 -  公众账号ID 
		$inputObj->SetMch_id(WxPayConfig::MCHID);//服务商- 商户号
		
		$inputObj->SetSub_Appid(WxPayConfig::Sub_APPID);//子商户 appid 
		$inputObj->SetSub_Mch_id(WxPayConfig::Sub_MCHID);//子商户 - 商户号
