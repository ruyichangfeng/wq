...
if($operation == 'display'){
    ...
    $permission = pdo_fetchall("SELECT id, uid, role FROM " . tablename('uni_account_users') . " WHERE uniacid = :uniacid and role != :role  ORDER BY uid ASC, role DESC", array(':uniacid' => $uniacid,':role' => 'clerk'), 'uid');
    if(!empty($permission)){
