...
<form class="layui-form" >
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="in[name]" value="<?php  echo $recorder['name'];?>" required="" style="width: 400px;" lay-verify="required" placeholder="填写分类名" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    layui.use(['form','jquery'], function(){
        ...
        form.on('submit(addAdmin)', function(data){
            $.post("<?php  echo $this->createWebUrl($_GPC['do'],array('tb'=>'category'))?>&Ajax=",data.field,function(response){
