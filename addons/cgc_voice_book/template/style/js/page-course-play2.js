$(function () {
    ...
    function movePlayer() {
        ...
        if (location.hash === '#/detail') {
        	if($('#course-play-detail').children('iframe').length == 0){
        		$('#course-play-detail').prepend($('#iframe'));
        	}
        } else if (location.hash === '') {
        	if($('#course-play-slider').children('iframe').length == 0){
        		$('#course-play-slider').prepend($('#iframe'));
        	}
        }
