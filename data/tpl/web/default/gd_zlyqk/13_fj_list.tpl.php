...
<blockquote class="layui-elem-quote ">
    <div class="layui-inline">
        ...
        <div class="layui-input-inline">
            <input type="text" value="<?php  echo $_GPC['name'];?>" id="name" placeholder="文件名搜索" class="layui-input search_input">
        </div>
        ...
        <div class="layui-input-inline" style="width: 150px;">
            <select name="app_id" id="app_id">
                ...
                <option value="<?php  echo $app['id'];?>" <?php  if($_GPC['app_id']==$app['id']) { ?> selected <?php  } ?>><?php  echo $app['name'];?></option>
                <?php  } } ?>
            </select>
        </div>
...
<div class="layui-form news_list" style="width: 100%;overflow: scroll">
    <table class="layui-table" style="min-width: 1400px;">
        ...
        <tr>
            ...
            <td align="left"><?php  echo $admin['gd_sn'];?></td>
            <td align="left"><?php  echo $admin['app_name'];?></td>
            <td>
                <?php  if(is_array($admin['file'])) { foreach($admin['file'] as $file) { ?>
                 <a href="<?php  echo $file['url'];?>" target="_blank" title="点击下载或查看"><?php  echo $file['name'];?></a>&nbsp;&nbsp;
                <?php  } } ?>
            </td>
            <td><?php  echo $admin['label_name'];?></td>
            <td align="left"><?php  echo $admin['up_name'];?></td>
