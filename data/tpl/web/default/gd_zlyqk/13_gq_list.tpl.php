...
<blockquote class="layui-elem-quote ">
    <div class="layui-inline">
        <div class="layui-input-inline">
            <input type="text" value="<?php  echo $_GPC['title'];?>" id="title" placeholder="标题搜索" class="layui-input search_input">
        </div>
...
<div class="layui-form news_list">
    <table class="layui-table">
        ...
        <tr>
            ...
            <td><?php  echo $admin['num'];?><?php  if($admin['unit']==1) { ?>月<?php  } else if($admin['unit']==2) { ?>年<?php  } else { ?>日<?php  } ?></td>
