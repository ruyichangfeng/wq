...
<div id="page0" class="ub ub-ver bga">
    <div class="ubb ubb-blaimg ub ub tx-c top-tab">
    	<a href="<?php  echo $this->createMobileUrl('staffmoney', array('foo'=>'index', 'id'=>$id))?>" class="ubr b-bla01 ub-f1 uinn t-gra block">收入</a>
        <a href="<?php  echo $this->createMobileUrl('staffmoney', array('foo'=>'chu', 'id'=>$id))?>" div class="ubr b-bla01 ub-f1 uinn t-gra block active">支出</a>
        <a href="<?php  echo $this->createMobileUrl('staffmoney', array('foo'=>'log', 'id'=>$id))?>" div class="ubr b-bla01 ub-f1 uinn t-gra block">充值</a>
    </div>

    <div class="ubb ubb-blaimg ub ub tx-c top-tab">
        <a href="<?php  echo $this->createMobileUrl('staffmoney', array('foo'=>'chu', 'id'=>$id))?>" class="ubr b-bla01 ub-f1 uinn t-gra block active">项目支出</a>
        <a href="<?php  echo $this->createMobileUrl('staffmoney', array('foo'=>'merchantchu', 'id'=>$id))?>" div class="ubr b-bla01 ub-f1 uinn t-gra block">商铺支出</a>
    </div>
        ...
        <?php  } else { ?>
            ...
            <div class="uba b-bla01 uc-a15 ub ub-ac umar-b" style="padding:0.2rem">
            	<table width="100%" border="0">
                  <tr>
                    <td class="uinn3">支出：<span class="t-gra">￥<?php  echo $vo['getmoney'];?></span></td>
                    <td class="uinn3">服务人员：<span class="t-gra"><?php  echo $this->getStaffInfo($vo['staff_id'],'staff_name')?></span></td>
                  </tr>
                  <tr>
                    <td colspan="2" class="uinn3">抢单项目：
                    <span class="t-gra">
                    <?php  echo $this->getServeType($vo['serve_type'])?> 
                    </span>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2" uinn3>支出时间：<span class="t-gra"><?php  echo $vo['addtime'];?></span></td>
                  </tr>
                </table>
            </div>
            <?php  } } ?>   
