...
var giftDetail = {
    ...
    event : function () {
        ...
        $$('div.pages div.page[data-page=gift-detail]').on('click','div.toolbar button', function (e) {
            ...
            var payWaySwitch = parseInt(btn.data('pay-way-switch'));
            ...
            if(giftMode == 1){
                ...
                }else if(payWaySwitch == 2){
                    url = "../addons/lonaking_gift_shop/template/mobile/assets/pages/gift-buy-form/gift-buy-default-2.html";
                }else if(payWaySwitch == 3){
                    url = "../addons/lonaking_gift_shop/template/mobile/assets/pages/gift-buy-form/gift-buy-default-3.html";
                }
