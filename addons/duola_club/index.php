...
require IA_ROOT. '/addons/duola_club/inc/version.php';
load()->model('reply');
load()->app('common');
...
if (empty($oauthurl)) {
	...
	$log = file_get_contents(IA_ROOT . "/addons/duola_club_oauth/update.php");
	$upgradeall = file_get_contents(IA_ROOT . "/addons/duola_club_oauth/upgrade.php");
	...
	$fmpath = IA_ROOT . '/addons/duola_club';
	if ($_GPC['type'] == 'check') {
