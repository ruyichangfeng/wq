...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="<?php  echo  $this->createWebUrl('base', array('foo'=>'fuwu'));?>">服务商加盟协议</a></li>
</ul>
...
<div class="clearfix">
    ...
    <form id="theform" class="form form-horizontal" action="<?php  echo $this->createWebUrl('base', array('foo'=>'fuwuok'));?>" method="post">
    ...
    <input type="hidden" name="type" value="1">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">服务商加盟协议</label>
