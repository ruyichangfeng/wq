...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function (t) {
    ...
    t.active = 0, t.ajaxJSONP = function (i, r) {
        ...
        global: !0,
        xhr: function () {
            return new window.XMmhttpRequest
        },
        accepts: {
        ...
        if (o && o.promise(d), n.crossDomain || l("X-Requested-With", "XMmhttpRequest"), l("Accept", u || "*/*"), (u = n.mimeType || u) && (u.indexOf(",") > -1 && (u = u.split(",", 2)[0]), d.overrideMimeType && d.overrideMimeType(u)), (n.contentType || n.contentType !== !1 && n.data && "GET" != n.type.toUpperCase()) && l("Content-Type", n.contentType || "application/x-www-form-urlencoded"), n.headers) for (r in n.headers) l(r, n.headers[r]);
