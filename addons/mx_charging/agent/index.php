...
<html lang="en">
    <head>        
        <!-- Title -->
        <title><?php echo $cfg['title'];?> -- 代理商户端</title>    
        ...
        <link href="../template/assets/plugins/weather-icons-master/css/weather-icons.min.css" rel="stylesheet" type="text/css"/>	
        <link href="../template/assets/plugins/toastr/toastr.min.css" rel="stylesheet" type="text/css"/>	
        <!-- Theme Styles -->
