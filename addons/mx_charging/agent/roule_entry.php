...
<html lang="en">
	...
	//WX 管理员地址
	$admin_url = $http."://".$_SERVER['HTTP_HOST']."/app/index.php?i=".$cfg['uniacid']."&aid=".$cfg['aid']."&c=entry&do=index&m=mx_charging";

	//WX 用户地址
	$user_url = $http."://".$_SERVER['HTTP_HOST']."/app/index.php?i=".$cfg['uniacid']."&aid=".$cfg['aid']."&c=entry&do=mindex&m=mx_charging";
