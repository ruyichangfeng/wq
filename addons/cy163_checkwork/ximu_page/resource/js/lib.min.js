	...
	d.fn.bxSlider = function(b) {
		...
		var a = {},
			...
			p = function() {
				...
				else for (var b = 0, p = 0; b < a.children.length;)++f, b = p + m(), p += a.settings.moveSlides <= m() ? a.settings.moveSlides : m();
...
(function() {
	...
	this.WOW = function() {
		...
		return c.prototype.defaults = {
			...
			else for (e = this.boxes, b = 0, c = e.length; c > b; b++) a = e[b], this.applyStyle(a, !0);
