...
<div class="panel_box row">
    <div class="panel col"  style="width: 14%;">
        <a  href="javascript:" class="open_mn" data-url="<?php  echo $this->createWebUrl('list',array('tb'=>'pool'))?>&status=-1&ac=all_plan" style="background-color:#FF5722!important">
    ...
    <div class="panel col"  style="width: 14%;">
        <a  href="javascript:" class="open_mn" data-url="<?php  echo $this->createWebUrl('list',array('tb'=>'pool'))?>&status=5&ac=wait_plan" style="background-color:#FFB800!important">
            <div class="panel_word newMessage">
    ...
    <div class="panel col" style="width: 14%;" >
        <a   href="javascript:" class="open_mn" data-url="<?php  echo $this->createWebUrl('list',array('tb'=>'pool'))?>&status=10&ac=fi_plan" style="background-color:#009688!important;">
    ...
    <div class="panel col" style="width: 14%;" >
        <a  href="javascript:" class="open_mn" data-url="<?php  echo $this->createWebUrl('list',array('tb'=>'pool'))?>&status=1&ac=do_plan" style="background-color:#2F4056!important;">
            <div class="panel_word imgAll">
    ...
    <div class="panel col" style="width: 14%;" >
        <a  href="javascript:" class="open_mn" data-url="<?php  echo $this->createWebUrl('list',array('tb'=>'pool'))?>&status=6&ac=end_plan" style="background-color:#1E9FFF!important">
    ...
    <div class="panel col" style="width: 14%;" >
        <a  href="javascript:" class="open_mn" data-url="<?php  echo $this->createWebUrl('list',array('tb'=>'pool'))?>&status=2&ac=fina_plan" style="background-color:#393D49!important">
            <div class="panel_word userAll" >
    ...
    <div class="panel col max_panel"  style="width: 14%;">
        <a  href="javascript:" class="open_mn" data-url="<?php  echo $this->createWebUrl('list',array('tb'=>'pool'))?>&status=3&ac=delete_plan" style="background-color:#c2c2c2">
            <div class="panel_word waitNews" >
                <span><?php  echo intval($total['3'])?></span>
                <cite>已取消</cite>
            </div>
        </a>
    </div>
...
<blockquote class="layui-elem-quote" style="padding-top:2px;padding-bottom: 2px;">
    <div class="layui-inline">
        <div class="layui-input-inline" style="width: 90px;padding-bottom: 3px;">
        ...
        <div class="layui-input-inline" style="width: 90px;padding-bottom: 3px;">
            <select name="city" id="property"  lay-verify="required">
                <option value="0">所有级别</option>
                <?php  if(is_array($propertyList)) { foreach($propertyList as $pk => $item) { ?>
                <option value="<?php  echo $pk;?>" <?php  if($pk==$_GPC['property']) { ?>selected<?php  } ?>><?php  echo $item;?></option>
                <?php  } } ?>
            </select>
        </div>
        <div class="layui-input-inline" style="width: 90px;padding-bottom: 3px;">
        ...
        <div class="layui-input-inline" style="width: 90px;padding-bottom: 3px;">
            <input type="text" value="<?php  echo $_GPC['name'];?>" id="name" placeholder="数据提交人搜索" class="layui-input search_input">
        </div>
        <div class="layui-input-inline" style="width: 90px;padding-bottom: 3px;">
