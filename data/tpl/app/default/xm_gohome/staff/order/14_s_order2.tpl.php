    ...
    <ul class="ub-f1 uinn8 c-wh">
        ...
        <?php  } else { ?>
        	<?php  if(is_array($list)) { foreach($list as $vo) { ?>
                <?php  if($vo['selected'] == 3) { ?>
                    <a onClick="noshow(<?php  echo $vo['id'];?>,1)" class="uba b-bla01 uc-a15 ub ub-ac umar-b" style="padding:0.2rem 0">
                <?php  } else { ?>
                    <?php  if($this->getWait($vo['order_id']) == 0) { ?>
                    ...
                    <?php  } else { ?>
                        <a onClick="noshow(<?php  echo $vo['id'];?>,2)" class="uba b-bla01 uc-a15 ub ub-ac umar-b" style="padding:0.2rem 0">
                    <?php  } ?>
                <?php  } ?>
                    ...
                    <div class="ub-f1 ub ub-ver ubl ubr b-bla01" style=" padding:0.3rem 0.5rem">
                        <div class="ub ub-ac">
                            ...
                            <div class="t-gre1"><span class=" ulev1"><?php  echo $vo['offer'];?></span></div>
                        </div>
