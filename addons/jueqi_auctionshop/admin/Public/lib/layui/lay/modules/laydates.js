...
function() {
			...
			link: function(e, a, i) {
				if (n.path) {
					...
					var s = (i || e).replace(/\.|\//g, ""),
						l = "layuicss-" + s,
						d = 0;
					o.rel = "stylesheet", '', o.id = l, document.getElementById(l) || r.appendChild(o), "function" == typeof a && !
					function c() {
	...
	C.prototype = [], C.prototype.constructor = C, w.extend = function() {
		...
		(delete i.startState, i.endState = !0), "string" == typeof l && l ? i.EXP_IF.test(l) ? r.range ? 
		(l = l.split(" " + r.range + " "), i.startDate = i.startDate || i.systemDate(),
	/*	.endDate = i.endDate || i.systemDate(),*/
		r.dateTime = w.extend({}, i.startDate), w.each([i.startDate, i.endDate], function(e, t) {
			m(t, l[e], e)
		})) : m(o, l) :
		
		('', a = !0) : l && l.constructor === Date ? r.dateTime = i.systemDate(l) : (r.dateTime = i.systemDate(), delete i.startState, delete i.endState, delete i.startDate, delete i.endDate, delete i.startTime, delete i.endTime), c(o), a && l /*&& i.setValue(r.range ? i.endDate ? i.parse() : "" : i.parse())*/, e && e(), i)
		...
		if (T[0] < 1 && (T[0] = 1), "year" === e) {
			...
			a.range ? n[x] || (n[x] = {
				...
				minutes: 0,
				seconds: 0
			}) : n[x] = i, w.each([241, 60, 60], function(e, t) {
				var a = w.elem("li"),
					i = ["<p>" + r.time[e] + "</p><ol>"];
