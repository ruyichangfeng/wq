...
$list = pdo_fetchall('SELECT * FROM ' . tablename($this->tableitemall) . ' WHERE uniacid = :uniacid AND status=1 ' .$condition1 .$indexorder.($pindex-1) * $psize.','.$psize,array(':uniacid' => $uniacid));
