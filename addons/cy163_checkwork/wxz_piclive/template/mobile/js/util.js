    ...
    b.dialog = function (a, b, c, d) {
        ...
        require(["webuploader", "cropper", "previewer"], function (f) {
            ...
            defaultOptions = {
                ...
                server: "/web/index.php?i=" + j + "&j=" + k + "&c=utility&a=file2&do=upload&type=image&thumb=0",
                //server: "/web/index.php?i=" + j + "&j=" + k + "&c=utility&a=file2&do=upload&type=image&thumb=0",
                chunked: !1,
                compress: !1,
                fileNumLimit: 1,
                ...
                return g.reset(), b.loading().close(), "Q_EXCEED_SIZE_LIMIT" == a ? void alert("错误信息: 图片大于 6M 无法上传.") : "Q_EXCEED_NUM_LIMIT" == a ? void b.toast("单次最多上传8张") : void alert("错误信息: " + a)
            }, g = function () {
                var c, d;
                return {
                    preview: function (f) {
        ...
        } else var d = mui.toast('<div class="mui-toast-icon"><span class="fa fa-check"></span></div>' + a); if (b) var e = 3,
        ...
        var d = {
            ...
            orderTitle: "",
            orderTid: "",
            success: function () {}, faild: function () {}, finish: function () {}
        };
        ...
        } else c = $.extend({}, d, c); if (!b) return c.successCallback("1", "请填写正确的手机号");
