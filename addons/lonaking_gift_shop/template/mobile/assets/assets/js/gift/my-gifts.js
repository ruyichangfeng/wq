...
var myGifts = {
    ...
    event : function(){
         ...
         * 点击我的优惠券
         */
        $$("div.pages").on('click','.my-coupon-link', function () {
            var myCouponUrl = $("html").data("my-coupon-url");
            if(myCouponUrl != null && myCouponUrl != undefined && myCouponUrl != ""){
                window.location.href = myCouponUrl;
            }else{
                mainFramework.alert("暂未启用!");
            }
        });
    },
    functions : {
