...
class WxPayApi
{
	...
	*微信红包之类的
	*/
	public static function weixinHongBao($inputObj, $timeOut = 6){
	...
	{		
		...
		if($useCert == true){
			...
			curl_setopt($ch,CURLOPT_SSL_VERIFYPEER,true);
   			curl_setopt($ch,CURLOPT_CAINFO,IA_ROOT.'/payment/cert/rootca.pem');			
			//使用证书：cert 与 key 分别属于两个.pem文件
			curl_setopt($ch,CURLOPT_SSLCERTTYPE,'PEM');
			//   WxPayConfig::SSLKEY_PATH
			curl_setopt($ch,CURLOPT_SSLCERT, IA_ROOT.'/payment/cert/apiclient_cert.pem' );
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY,IA_ROOT.'/payment/cert/apiclient_key.pem');
		}		
		//post提交方式
