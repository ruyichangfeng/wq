...
<style>
    .adm_ln,.user_ln{line-height: 35px;margin-right:10px;}
</style>
        ...
        <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
            <div class="layui-tab-content" >
                <div class="layui-tab-item layui-show">
                        ...
                        <div class="layui-input-block ">
                            ...
                            <?php  } else { ?>
                                ...
                                <?php  if(is_array($dpSelect)) { foreach($dpSelect as $index => $fl) { ?>
                                    <a href="javascript:" class="adm_ln"><input type="hidden" name="admin[<?php  echo $index;?>]" value="<?php  echo $fl;?>"><?php  echo $dpList[$fl];?> </a>
                                <?php  } } ?>
                                <?php  } else { ?>
                                    <a href="javascript:" class="adm_ln">无</a>
                                <?php  } ?>
                    ...
                    <div class="layui-form-item role_hd" <?php  if($nodeInfo['who']==2) { ?> style="display:none" <?php  } ?>>
                        <label class="layui-form-label" style="text-align: left">选择员工</label>
                        <div class="layui-input-block ">
                            ...
                            <?php  } else { ?>
                                <?php  if($adminList) { ?>
                                <?php  if(is_array($adminList)) { foreach($adminList as $index => $adm) { ?>
                                    <a href="javascript:" class="user_ln"><input type="hidden" name="auser[<?php  echo $index;?>]" value="<?php  echo $adm['id'];?>"><?php  echo $adm['name'];?> </a>
                                <?php  } } ?>
                                <?php  } else { ?>
                                    <a href="javascript:" class="user_ln">无</a>
                                <?php  } ?>
                            <?php  } ?>
                            </span>
                            <a class="layui-btn layui-btn-primary layui-btn-small add_user">
                                <i class="layui-icon">&#xe654;</i>
                            </a>
                        </div>
                    </div>
    ...
    layui.use(['form','layer','element'], function(){
        ...
        $(".add_user").click(function(){
            ly =layui.layer.open({
                ...
                shade: 0.8,
                shadeClose: true,
                content: '<?php  echo $this->createWebUrl("wgive")?>&id=<?php  echo $nodeId;?>&flow_id=<?php  echo $flowId;?>'
            });
        });
        ...
        $("body").on("click",".user_ln",function(){
            $(this).remove();
        });
    });
