...
<div class="pull-right">
    <a href="<?php  echo $this->createWeburl('zxgl', array('op'=>'post'));?>"  class="btn btn-primary we7-padding-horizontal" style="margin-bottom: 20px">添加资讯内容</a>
</div>
<form class="form-horizontal" action="" method="post">
    <table class="table we7-table table-hover article-list vertical-middle">
        ...
        <tr>
            ...
            <td class="text-right">
                <a class="btn btn-default btn-sm" href="<?php  echo $this->createWeburl('zxgl', array('id' => $item['id'], 'op' =>'post'))?>" >编辑</a>
                <a class="btn btn-default btn-sm" onclick="return confirm('此操作不可恢复，确认吗？'); return false;" href="<?php  echo $this->createWeburl('zxgl', array('id' => $item['id'], 'op' => 'delete'))?>">删除</a>
            </td>
        </tr>
        <?php  } } ?>
    </table>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-1"></div>
                <div class="form-controls col-sm-3 help-block">建议不超过30个字</div>
            </div>
            <div class="form-group">
