...
<div class="panel panel-default">
	<div class="panel-heading">
		<div class="input-group" >
			...
			<input type="text" class="form-control" name="describeurl" value="<?php  echo $settings['describeurl'];?>">
		</div>	
	</div>
</div>
<div class="panel panel-default">
            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="name" id="name" value="<?php  echo $settings['name'];?>" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">商家简介</label>
                    <div class="col-sm-9">
                        <input type="text" name="desc" id="desc" value="<?php  echo $settings['desc'];?>" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">详细地址</label>
                    <div class="col-sm-9">
                        <input type="text" name="address" id="address" value="<?php  echo $settings['address'];?>" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">商家所在地区</label>
                        ...
                        <script type="text/javascript">
                            var location_p = "<?php  if(!empty($settings['location_p'])) { ?><?php  echo $settings['location_p'];?><?php  } else { ?>广东省<?php  } ?>";
                            var location_c = "<?php  if(!empty($settings['location_c'])) { ?><?php  echo $settings['location_c'];?><?php  } else { ?>汕头市<?php  } ?>";
                            var location_a = "<?php  if(!empty($settings['location_a'])) { ?><?php  echo $settings['location_a'];?><?php  } else { ?>龙湖区<?php  } ?>";
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-append">
                            <input type="text" id="place" class="form-control" style="width: 200px;display: inline" name="place" value="<?php  if(empty($settings)) { ?>汕头市龙湖区长平路127号<?php  } else { ?><?php  echo $settings['place'];?><?php  } ?>" data-rule-required="true">
...
<script type="text/javascript">
    ...
    var bmap = {
        'option': {
            ...
            'point': {'lng': "<?php  if($settings['lng']!='0.0000000000' && !empty($settings['lng'])) { ?><?php  echo $settings['lng'];?><?php  } else { ?>116.735049<?php  } ?>", 'lat': "<?php  if($settings['lat']!='0.0000000000' && !empty($settings['lat'])) { ?><?php  echo $settings['lat'];?><?php  } else { ?>23.367896<?php  } ?>"}
        },
