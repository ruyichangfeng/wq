    ...
    <div class="main" style="">
        ...
        <form method="post" class="form-horizontal form" id="form" novalidate="novalidate" style="">
            ...
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 col-lg-2 control-label">首页关于我们图片</label>
                <div class="col-xs-12 col-sm-8">
                    <?php  echo tpl_form_field_image('post[images]',$data['images']);?>
                </div>
            </div>
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 col-lg-2 control-label">首页关于我们内容</label>
                <div class="col-xs-12 col-sm-8">
                    <?php  echo tpl_ueditor('post[about_index]',$data['about_index']);?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-8">
                    <?php  echo tpl_ueditor('post[about]',$data['about']);?>
                </div>
            </div>

            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 col-lg-2 control-label">公司荣誉</label>
                <div class="col-xs-12 col-sm-8">
                    <div class="mui-input-cell">
                        <?php  echo tpl_form_field_multi_image('post[honor_img]',$data['honor_img'])?>
                    </div>
                </div>
            </div>
            <div class="form-group">
