		...
		<?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('menu', TEMPLATE_INCLUDEPATH)) : (include template('menu', TEMPLATE_INCLUDEPATH));?>
            <div class="page-inner">
                <div class="page-title">
                    <h3 class="breadcrumb-header">添加代理商</h3>
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" role="form" action="" method="POST">
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-1 control-label">登录名称</label>
                                            <div class="col-sm-11">
                                                <input type="text" class="form-control" name="user" required placeholder="输入代理商登录名称……">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputPassword3" class="col-sm-1 control-label">登录密码</label>
                                            <div class="col-sm-11">
                                                <input type="password" name="pwd" required class="password form-control" required  placeholder="输入代理商登录密码……">
                                            </div>
                                        </div>
										<div class="form-group">
                                            <label for="inputPassword3" class="col-sm-1 control-label">真实姓名</label>
                                            <div class="col-sm-11">
                                                <input type="text" name="true_name" class="password form-control" required  placeholder="输入代理商真实姓名……">												
                                            </div>
                                        </div>
                                       <div class="form-group">
                                            <label for="inputPassword3" class="col-sm-1 control-label">联系电话</label>
                                            <div class="col-sm-11">
                                                <input type="text" name="tel" class="password form-control" required  placeholder="输入代理商联系电话……">												
                                            </div>
                                        </div>
										 <div class="form-group">
                                            <label for="inputPassword3" class="col-sm-1 control-label">支付方式</label>
                                            <div class="col-sm-11">
                                                <select name="ispay" class="password form-control">
												  <option value="1" selected>服务商支付</option>
												  <option value="0">微信独立支付</option>
												</select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
												...
												<input type="submit" class="btn btn-success m-t-xxs" name="submit" value="立即添加">
                                            </div>
                                        </div>
                                    </form>
                                </div>
