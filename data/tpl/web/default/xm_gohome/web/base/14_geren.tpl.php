...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="<?php  echo  $this->createWebUrl('base', array('foo'=>'geren'));?>">个人加盟协议</a></li>
...
<div class="clearfix">
    ...
    <form id="theform" class="form form-horizontal" action="<?php  echo $this->createWebUrl('base', array('foo'=>'gerenok'));?>" method="post">
    ...
    <input type="hidden" name="type" value="1">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">个人加盟协议</label>
                <div class="col-sm-9 col-xs-12">
                    <?php  echo tpl_ueditor('xieyi_content', $item['xieyi_content']);?>
                </div>
            </div>
        </div>    
