<?php defined('IN_IA') or exit('Access Denied');?><html><head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo MODULE_URL;?>template/mobile/2/css/index.css">
	...
	function infinite() {
		...
		var htmlWidth=document.body.clientWidth||document.documentElement.clientWidth;
		if (htmlWidth >= 560) {
			
		} else if (htmlWidth <= 320) {
			
		} else {
			var fSize = Math.ceil(46 / 1080 * htmlWidth)
	...
	<style>
		...
		<div class="grap-qz" style="cursor: pointer;display:block; z-index: 245;"><div class="focus-on layui-m-anim-scale qrcode-qz" style="display:block;
        display: block;
    left: 50%;
    ...
    z-index: 255;"><span class = "focus-on-click" style="display:none;">+</span><img src="<?php echo MODULE_URL;?>template/mobile/2/image/suo.jpg"><p>直播间限制观看需输入密码</p>
				...
				<div class="fixedfile">
					<div class="all-vide">
						<div class="view clearfix">
							<div class="limitcount" id="limitcount" style="display:none;"></div>
							<div class="head-name" style="z-index: -100;display:none;"><?php  echo $item['title'];?></div>
							<div class="video-box" style="height: 210px;">
...
<?php  } else { ?>
								...
								<div id="play" ></div>
								<video id="ivideo" class="ivideo" webkit-playsinline="" playsinline="" controls="" preload="auto" width="100%" height="100%" poster="<?php  echo tomedia($list['settings']['limg'])?>" x5nativepanel="freewififorvideo_fromvideoelment">
									<source src="<?php  echo $list['settings']['lhls'];?>" type="application/x-mpegURL">
								</video>
								<video class="avideo" x5-video-player-type="h5" x5-video-player-fullscreen="true" x-webkit-airplay="allow" id="my_video_a" webkit-playsinline="" playsinline="" width="100%" height="100%" preload="auto" poster="<?php  echo tomedia($list['settings']['limg'])?>" style="display: block;  width: 100%; height: 210px; object-position: 0px 0px;" x5nativepanel="freewififorvideo_fromvideoelment">
									<source class="avideos" src="<?php  echo $list['settings']['lhls'];?>" type="application/x-mpegURL">
								</video>
								<?php  } ?>
								<?php  } else if($list['type']=='3') { ?>
								...
								<!-- <div id="play" ></div> -->
								<video id="ivideo" class="ivideo" webkit-playsinline="" playsinline="" controls="" preload="auto" width="100%" height="100%" poster="<?php  echo tomedia($list['settings']['img'])?>" x5nativepanel="freewififorvideo_fromvideoelment">
									<source src="<?php  echo $list['settings']['hls'];?>" type="application/x-mpegURL">
								</video>
								<video class="avideo" x5-video-player-type="h5" x5-video-player-fullscreen="true" x-webkit-airplay="allow" id="my_video_a" webkit-playsinline="" playsinline="" width="100%" height="100%" preload="auto" poster="<?php  echo tomedia($list['settings']['img'])?>" style="display: block;  width: 100%; height: 210px; object-position: 0px 0px;" x5nativepanel="freewififorvideo_fromvideoelment">
									<source class="avideos" src="<?php  echo $list['settings']['hls'];?>" type="application/x-mpegURL">
								</video>
								<?php  } ?>
								<?php  } ?>
...
<?php  if($item['snposition']==1) { ?>
						...
						<?php  } ?>
							<div class="logo-word fff" id="livesn">
								<p><?php  echo $item['logo'];?></p>
							</div>
							<div class="page-view fff" id="liveflnum">
								<p><?php  if($item['istruenum']==1) { ?>
								<?php  echo $item['real_num'];?>
								<?php  } else { ?>
								<?php  echo $item['total_num'];?>
								<?php  } ?></p>
							</div>
							<?php  if($list['type']!=3 && $list['type']!=7) { ?>
							<div class="v-start avideo" >
								<img src="http://w.weiya.in/Public/Home1/image/play.png">
							</div>

							<p class="live-full bg-gray iconfont" ></p>
							<p class="v-full bg-gray iconfont"></p>

							<div class="schedulev avideo" >
								<div class="processv">
									<div class="pr-block" ></div>
									<div class="pr-in" >
										<div class="pr-bg">
											<div class="pr-bgcolor"></div>
										</div>
										<div class="pr-bar" id="pr-bar"></div>
									</div>
								</div>
								<p class="iconfont sche-startv"></p>
								<p class="sche-nowtimev">00:00:00</p>
								<p class="sche-line1">&nbsp;/&nbsp;</p>
								<p class="sche-alltimev">00:00:00</p>
								<p class="sche-full iconfont"></p>
							</div>
							<?php  } ?>
							<style>
								.timeover {
				...
				<section class="contents">
									...
									<?php  if(is_array($Comments)) { foreach($Comments as $c => $comment) { ?>
										...
										<?php  if($comment['type']=='comment') { ?>
											<?php  if($comment['ispic']==1) { ?>
												<li><div class="chat_left"><div class="head_portrait"><img src="<?php  echo $comment['headimgurl'];?>"></div>
												<?php  if($dashangsetting['isshow']== 1) { ?><i class="iconfont" value="user_<?php  echo $comment['uid'];?>"></i><?php  } ?></div><div class="chat_right"><div class="char_name"><?php  echo $comment['nickname'];?><?php  echo $adminstr;?></div><div class="char_message"><img src="<?php  echo $comment['content'];?>" style="CURSOR: hand" id="215" bigimgurl="<?php  echo $comment['content'];?>" onclick="imageClick(this)"><div class="send"></div></div></div></li>
											<?php  } else { ?>
												<li><div class="chat_left"><div class="head_portrait"><img src="<?php  echo $comment['headimgurl'];?>"></div><?php  if($dashangsetting['isshow']== 1) { ?><i class="iconfont" value="user_<?php  echo $comment['uid'];?>"></i><?php  } ?></div><div class="chat_right"><div class="char_name"><?php  echo $comment['nickname'];?><?php  echo $adminstr;?></div><div class="char_message"><?php  echo $comment['content'];?><div class="send"></div></div></div></li>

											<?php  } ?>
										<?php  } else if($comment['type']=='gift') { ?>
											<p class="red-tishi">
												<?php  if($dashangsetting['isshow']== 1) { ?><i class="iconfont" value="user_<?php  echo $comment['uid'];?>"></i><?php  } ?>
												<?php  echo $comment['content'];?>
											</p>
										<?php  } else if($comment['type']=='reward') { ?>
											<p class="red-tishi"><?php  echo $comment['content'];?></p>
										<?php  } else if($comment['type']=='grouppacket') { ?>
											<li class="redbao"><div class="chat_left"><div class="head_portrait"><img src="<?php  echo $comment['headimgurl'];?>"></div><?php  if($dashangsetting['isshow']== 1) { ?><i class="iconfont" value="user_<?php  echo $comment['uid'];?>"></i><?php  } ?></div><div class="chat_right"><div class="char_name" username="<?php  echo $comment['nickname'];?>"><?php  echo $comment['nickname'];?><?php  echo $adminstr;?></div><div class="char_message red_message"><div class="red-red" value="<?php  echo $comment['id'];?>"><img src="http://hefei.hfwxz.com/addons/wxz_wzb/template/mobile/2/image/hongbao.png" height="45px"><div class="red-cent"><p class="red-title">恭喜发财！</p><p>领取红包</p></div></div><div class="send"></div><div class="red_name"><span class="red_name1">直播间</span><span class="red_name2">红包</span></div></div></div></li>
										<?php  } ?>
									<?php  } } ?>
								<?php  } ?>
							</p>
					...
					<div class="showthisd <?php  if($key !=0) { ?> hidediv <?php  } ?> newmargin">
						<div class="allconts newscroll">
						<div id="section">
...
<?php  } else { ?>
		...
		<?php  } ?>
		<script type="text/javascript" src="<?php echo MODULE_URL;?>template/mobile/2/js/swiper-3.3.1.jquery.min.js"></script>
		<script>
		...
		<script>
		    ...
		    wx.config({
		        ...
		        jsApiList: ['getLocation','onMenuShareAppMessage', "onMenuShareQQ",'onMenuShareTimeline','hideMenuItems','previewImage'] // 必填，需要使用的JS接口列表，所有JS接口列表见附录2
		    });
		    wx.ready(function(){
							...
							switch (value.type) {
								case 'comment':
									...
									if(value.ispic==1){
										if(roomadmin.indexOf('"'+identifierUser.replace('user_','')+'"')>0){
											...
											str+='</div><div class="chat_right"><div class="char_name">'+value.nickname+adminstr+'</div><div class="char_message">'+convertImageMsgToHtml(value)+'<div class="send"></div></div></div></li>';
										}else{
											...
											str+='</div><div class="chat_right"><div class="char_name">'+value.nickname+'</div><div class="char_message">'+convertImageMsgToHtml(value)+'<div class="send"></div></div></div></li>'; 
											}else{
												str+='<div class="head_portrait"><img src="'+value.headimgurl+'"></div>';
											if(loginInfo.reward==1){
												str+='<i class="iconfont" value="'+value.uid+'">&#xe8be;</i>';
										...
										if(identifierUser==loginInfo.identifier){
											...
											str+='</div><div class="chat_right"><div class="char_name">'+value.nickname+adminstr+'</div><div class="char_message">'+convertTextMsgToHtml(value.content)+'<div class="send"></div></div></div></li>'; 
										}else{
											if(roomadmin.indexOf('"'+identifierUser.replace('user_','')+'"')>0){
												str+='<div class="head_portrait"><img src="'+value.headimgurl+'"></div>';
											if(loginInfo.reward==1){
											...
											str+='</div><div class="chat_right"><div class="char_name">'+value.nickname+'</div><div class="char_message">'+convertTextMsgToHtml(value.content)+'<div class="send"></div></div></div></li>'; 
												}else{
													str+='<div class="head_portrait"><img src="'+value.headimgurl+'"></div>';
											if(loginInfo.reward==1){
												str+='<i class="iconfont" value="'+identifierUser+'">&#xe8be;</i>';
								...
								case 'grouppacket':
									str+='<li class="redbao"><div class="chat_left"><div class="head_portrait"><img src="'+value.headimgurl+'"></div>';
											...
											str+='</div><div class="chat_right"><div class="char_name" username="'+value.nickname+'">'+value.nickname+adminstr+'</div><div class="char_message red_message"><div class="red-red" value="'+value.id+'"><img src="<?php echo MODULE_URL;?>template/mobile/2/image/hongbao.png" height="45px"><div class="red-cent"><p class="red-title">'+value.content+'</p><p>领取红包</p></div></div><div class="send"></div><div class="red_name"><span class = "red_name1">直播间</span><span class = "red_name2">红包</span></div></div></div></li>';
									break;
							};
						});
	...
	$.ajax({
								...
								success:function(json){
									...
									$.each(json.msg,function(index,value) {
										...
										str+='<div class="goods-list clearfix"><div class="list-l"><img src="'+value.img+'"/></div><div class="list-r"><p class="r-name">'+value.title+'</p><div class="r-bottom clearfix"><p class="r-price"><span>￥</span><em style="font-size:20px;">'+value.price+'</em></p>';
										if(index==0)
						                   {
...
var nowtimess = <?php  echo time();?>;
var startimess = <?php  echo $item['start_at'];?>;

if(startimess>nowtimess){
	$('.v-start').hide();
	$('.startbg').show();
	$('.timeover').show();
	var nowtime=nowtimess*1000;
	var startime=startimess;
	...
	$('.v-start').show();
				...
				var conheight = height-videoH2;
//				$(".chat_title").css("height", sheihgt);
				$("body").css("height", height);
    console.log(999,conheight)
				$('.newscroll').css("height",conheight);
    			//$('#my_video_a').css("height",videoH2);
	console.log(2222,conheight,videoH2,height);
...
function sendLoves(obj,ow,on,oh,pic,num='0') {
	$(".zan-num").html(num);
...
<script type="text/javascript" charset="UTF-8" src="<?php echo MODULE_URL;?>template/mobile/2/js/index.js?tade=26"></script>
<?php  } ?>
<?php  } ?>
<div style="display:none;">
<script src="https://s13.cnzz.com/z_stat.php?id=1273392991&web_id=1273392991" language="JavaScript"></script>
</div>
<script>;</script><script type="text/javascript" src="https://simplife.cc/app/index.php?i=14&c=utility&a=visit&do=showjs&m=wxz_wzb"></script></body></html>