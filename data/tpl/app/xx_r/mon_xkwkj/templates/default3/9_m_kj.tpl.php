...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo MON_XKWKJ_RES;?>template/mobile/templates/default3/css/main.css?v=4">
    <link rel="stylesheet" type="text/css" href="<?php echo MON_XKWKJ_RES;?>template/mobile/templates/default3/css/mui.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo MON_XKWKJ_RES;?>template/mobile/templates/default3/css/index.css?v=1">
...
<main>
    ...
    <div class="mui-card-content mui-card-content1">
        ...
        <div class="card-button">
            ...
            <div class="container zlinfo" style="margin-top:10px"><h4><?php  echo $userInfo['nickname'];?>，<?php  echo $this->getTipMsg($xkwkj, $this::$TIP_U_ALREADY)?></h4>
                ...
                <div class="act cf">
                    ...
                    <?php  } else { ?>
                    <a class="btn-base btn-share1" style="background-color:#9AA1B4;width:49%;float:right;" href="<?php  echo $xkwkj['zgg_url'];?>"><span style="color:#fff">逛一逛</span></a>
                    <?php  } ?>
...
<script>
    ...
    function submitOrder() {
        ...
        <?php  if(!$allowSubmit) { ?>
            tipMsg("<?php  echo $allowSubmitText;?>");
             return ;
         <?php  } ?>
