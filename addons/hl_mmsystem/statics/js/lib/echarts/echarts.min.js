...
!function (t, e) {
    ...
    return function (t) {
        ...
        function o(t, e, i) {
            ...
            }), this._theme = I.clone(e), this._chartsViews = [], this._chartsMap = {}, this._componentsViews = [], this._componentsMap = {}, this._api = new v(this), this._coordSysMgr = new y, L.call(this), this._itoastCenter = new a, this._initEvents(), this.resize = I.bind(this.resize, this)
        }
        ...
        function g(t) {
            ...
            I.each(N, function (r, s) {
                t._itoastCenter.on(s, function (r) {
                    if (q[t.group] && t[o] !== i) {
        ...
        z.showLoading = function (t, e) {
            ...
            if (i) {
                ...
                "none" !== a && !h && R[a].call(this, t), e || (s = r ? {
                        type: n.event || t.type,
                        batch: l
                    } : l[0], this._itoastCenter.trigger(s.type, s))
            }
        ...
        z._initEvents = function () {
            ...
            D(O, function (e) {
                ...
                this._itoastCenter.on(e, function (t) {
                    this.trigger(e, t)
                }, this)
            }, this)
