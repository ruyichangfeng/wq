<?php defined('IN_IA') or exit('Access Denied');?><script type="text/javascript" src="<?php echo MODULE_URL;?>public/mobile/js/jquery-1.11.3.min.js?v=4.8"></script>
...
<style>
    ...
    .new_bottom_menu3 li.mid a { /*box-shadow: 0 -1px 1px #ccc;*/position: absolute;left: 0;right: 0;margin: 0 auto;width: 64px;height: 64px;border: 5px solid #fff;top: -13px;	border-radius: 35px;	background: url(<?php echo OSSURL;?>public/mobile/img/bottom_menu_icon_add.png) no-repeat center;background-size: 20px;background-color: #dd8a37;z-index: 3;}
    .new_bottom_menu3 li:nth-child(2) a {background-image: url(<?php echo MODULE_URL;?>public/mobile/img/user.png);}
    .new_bottom_menu3 li:nth-child(1) a {background-image: url(<?php echo MODULE_URL;?>public/mobile/img/home1.png);}
    .new_bottom_menu3 li:nth-child(2) a {background-image: url(<?php echo MODULE_URL;?>public/mobile/img/user.png);}
    .new_bottom_menu3 li:nth-child(4) a {background-image: url(<?php echo MODULE_URL;?>public/mobile/img/teacher.png);}
    .new_bottom_menu3 li:nth-child(5) a { background-image: url(<?php echo MODULE_URL;?>public/mobile/img/company.png);}
    .new_bottom_menu3 li:nth-child(1) a.act {background-image: url(<?php echo MODULE_URL;?>public/mobile/img/bottom_menu_icon1_Select.png);}
    .new_bottom_menu3 li:nth-child(2) a.act { background-image: url(<?php echo MODULE_URL;?>public/mobile/img/bottom_menu_icon2_Select.png);}
    .new_bottom_menu3 li:nth-child(4) a.act {background-image: url(<?php echo MODULE_URL;?>public/mobile/img/bottom_menu_icon3_Select.png);}
    .new_bottom_menu3 li:nth-child(5) a.act {background-image: url(<?php echo MODULE_URL;?>public/mobile/img/bottom_menu_icon4_Select.png);}
    .new_bottom_menu3 li.mid a .plus_icon {z-index: 6;width: 64px;height: 64px;box-sizing: border-box;border: 5px solid #fff;border-radius: 40px;background: url(<?php echo OSSURL;?>public/mobile/img/bottom_menu_icon_add.png) no-repeat center;background-size: 20px;background-color: #dd8a37;position: absolute;top: 0px;left: 0px;}
    ...
    .new_bottom_menu3 li.mid a{ /*box-shadow: 0 -1px 1px #ccc;*/border-top: 0px solid #ccc;border-radius: 36px;position: absolute;left: 0;right: 0; margin: 0 auto;width: 64px;height: 64px;top: -13px;z-index: 3;/*background-color: #dd8a37;*/}
    .new_bottom_menu3 li.mid a:before{ /*content:''; width:64px; height: 64px;  position:absolute; top:-6px; left:-5px; border-radius: 36px; z-index:1;*/}
...
<ul class="new_bottom_menu3">
    <li class="menu_li">
        <a href="<?php  echo $this->createMobileUrl('detail', array('schoolid' => $schoolid), true)?>" <?php  if($act =='sy') { ?>class=act<?php  } ?>>
            <div>首页</div>
        </a>
    </li>
    <li class="menu_li">
        <a href="javascript:alert('正在加速开发中,敬请期待!')" <?php  if($act =='bjq') { ?>class=act<?php  } ?>>
            <?php  if($unread == 1) { ?><div class="new_info_tips_3"></div><?php  } ?>
            <div>家长</div>
        </a>
    </li>
    <li class="mid">
    ...
    <li class="menu_li">
        <a href="javascript:alert('正在加速开发中,敬请期待!')" <?php  if($act =='tx') { ?>class=act<?php  } ?>>
            <div>老师</div>
        </a>
    </li>
    <li class="menu_li">
        <a href="<?php  echo $this->createMobileUrl('jianjie', array('schoolid' => $schoolid), true)?>" <?php  if($act =='wd') { ?>class=act<?php  } ?>>
            <div>平台</div>
        </a>
    </li>
</ul>
<div class="circle_menu_div" id="circle_menu_div">
    <svg id="menu" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-2 -2 560 560" style="transition: transform .3s; -webkit-transition: -webkit-transform .3s; -webkit-transition: transform .3s; transform-origin: 50% 50% 0px; -webkit-transform-origin: 50% 50% 0px; transform: translate3d(0px, 0px, 0px) rotate(-180deg); -webkit-transform: translate3d(0px, 0px, 0px) rotate(-180deg); touch-action: none; -webkit-user-select: none;">
        ...
        <g id="itemsContainer">
            <?php  echo $this->createMobileUrl('kc', array('schoolid' => $schoolid), true)?>
            <a class="item" id="item-1" role="link" tabindex="0" xlink:href="javascript:alert('正在加速开发中,敬请期待!')" xlink:title=" " style="" data-svg-origin="280 280">
            ...
            <?php  echo $this->createMobileUrl('teachers', array('schoolid' => $schoolid), true)?>
            <a class="item" id="item-2" role="link" tabindex="0" xlink:href="javascript:alert('正在加速开发中,敬请期待!')" xlink:title=" " style="" data-svg-origin="280 280">
            ...
            <?php  echo $this->createMobileUrl('kc', array('schoolid' => $schoolid,'typeId' => 143,'typeName' => 'menu'), true)?>
            <a class="item" id="item-3" role="link" tabindex="0" xlink:href="javascript:alert('正在加速开发中,敬请期待!')" xlink:title=" " style="" data-svg-origin="280 280">
            ...
            <?php  echo $this->createMobileUrl('kc', array('schoolid' => $schoolid,'typeId' => 144,'typeName' => 'menu'), true)?>
            <a class="item" id="item-4" role="link" tabindex="0" xlink:href="javascript:alert('正在加速开发中,敬请期待!')" xlink:title=" " style="" data-svg-origin="280 280">
