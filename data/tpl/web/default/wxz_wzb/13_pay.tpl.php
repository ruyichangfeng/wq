				...
				<form action="./index.php" method="get" class="form-horizontal" role="form">
					...
					<div class="form-group" style="text-align:right;">
						<div class="col-xs-12 col-sm-8 col-lg-11">
							...
							<a class="btn btn-default" href="<?php  echo $this->createWebUrl('pay',array('type' =>'all','rid'=>$rid))?>">全部</a>
						</div>
					</div>
				</form>
			</div>
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<a data-toggle="collapse" data-parent="#accordion"
					href="#collapse1">
					付费列表:<font style="color:red;">总金额<?php  echo $sum/100?>元</font>
				</a>
				</h4>
			</div>
			<div class="panel-body">
			...
			<thead class="navbar-inner">
				<tr>
					...
					<th align="center" style="width:10%;text-align:center;">付费金额</th>
