...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="<?php  echo  $this->createWebUrl('base', array('foo'=>'question'));?>">常见问题</a></li>
...
<div class="clearfix">
    ...
    <form id="theform" class="form form-horizontal" action="<?php  echo $this->createWebUrl('base', array('foo'=>'questionok'));?>" method="post">
